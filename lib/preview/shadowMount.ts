...
:host {
  ...
  /* 우리 앱 globals.css 의 --* variable 누출 차단 (Shadow DOM 은 custom property 를
     light DOM 부모로부터 상속받음 — all:initial 은 standard property 만 리셋하므로
     custom property 는 명시적 reset 필요). 4번째 catch fix. */
  --bg-canvas: initial;
  --bg-app: initial;
  --bg-elevated: initial;
  --bg-elevated-2: initial;
  --bg-hover: initial;
  --bg-active: initial;
  --bg-overlay: initial;
  ...
  --destructive-foreground: initial;
  --border: initial;
  --input: initial;
  --ring: initial;
  ...
  --font-sans: initial;
  --font-mono: initial;
  --cat-container: initial;
  --cat-input: initial;
  --cat-display: initial;
  --cat-dice: initial;
  --cat-expression: initial;
  --cat-sheetworker: initial;
  --cat-i18n: initial;
  --cat-css: initial;
  --cat-advanced: initial;
  --cat-composite: initial;
  --header-h: initial;
  --statusbar-h: initial;
  --sidebar-left-collapsed: initial;
  --sidebar-left-w: initial;
  --sidebar-right-w: initial;
  --sidebar-right-min: initial;
  --sidebar-right-max: initial;
  --radius: initial;
  --radius-sm: initial;
  --radius-md: initial;
  --radius-lg: initial;
