...
assert.equal(getLayerPanelAutoScrollDelta(102, { top: 100, bottom: 500 }), -17);
assert.equal(getLayerPanelAutoScrollDelta(498, { top: 100, bottom: 500 }), 17);
assert.equal(getLayerPanelAutoScrollDelta(300, { top: 100, bottom: 500 }), 0);
assert.equal(getLayerPanelAutoScrollDelta(102, { top: 100, bottom: 500 }, 48, 0), -1);
assert.equal(getLayerPanelAutoScrollDelta(Number.NaN, { top: 100, bottom: 500 }), 0);
