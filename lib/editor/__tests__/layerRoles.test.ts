...
assert.equal(classifyLayerRole('r20_hr'), 'flow');
assert.equal(classifyLayerRole('r20_spacer'), 'flow');
assert.equal(classifyLayerRole('r20_inline_break'), 'flow');
assert.equal(classifyLayerRole('r20_icon'), 'media');
assert.equal(getLayerRole('r20_hr').canReceiveChildren, false);
assert.equal(getLayerRole('r20_spacer').canReceiveChildren, false);
...
assert.equal(classifyLayerRole('r20_rolltemplate_define'), 'frame');
assert.equal(classifyLayerRole('r20_rolltemplate_row'), 'flow');
assert.equal(classifyLayerRole('r20_rolltemplate_cond_if'), 'flow');
assert.equal(classifyLayerRole('r20_rolltemplate_field_ref'), 'text');
assert.equal(getLayerRole('r20_rolltemplate_define').canReceiveChildren, true);
assert.equal(getLayerRole('r20_rolltemplate_row').canReceiveChildren, true);
