...
export default function RolltemplateEditSurface() {
  ...
  const createTemplate = useCallback(() => {
    ...
    const styles = [
      [titleId, { padding: '8px 10px', 'font-size': '18px', 'font-weight': '700' }],
      [rowId, { display: 'flex', gap: '8px', padding: '8px 10px', 'align-items': 'center' }],
      [labelId, { 'font-weight': '600' }],
      [valueId, { 'margin-left': 'auto', 'font-size': '18px', 'font-weight': '700' }],
    ] as const;
