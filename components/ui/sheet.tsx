...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-card text-card-foreground p-4 shadow-2xl border-border transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
