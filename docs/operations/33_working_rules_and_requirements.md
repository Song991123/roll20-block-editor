...
- This prohibition also applies to TODOs, progress logs, agent handoffs, and chat summaries. Record only anonymous fixture labels and generic implementation findings; do not retain creator/sheet names, distinctive source fragments, asset URLs, or source-derived measurements.
