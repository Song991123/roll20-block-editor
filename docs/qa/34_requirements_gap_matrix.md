...
| PARTIAL | P0 | Figma-like direct manipulation. | Flow/free placement, before/inside/after, grouping, container roles, multi-move, long-list navigation, and a nested scale plus rotate/skew/scale stack work locally. | Review dense imported trees, longer/dynamic transform stacks, individual transform properties, 3D/perspective, and longer mixed histories. |
