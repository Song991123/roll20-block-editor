...
const ATTR_FIELD_MAP = {
  ...
  r20_select_option: { value: 'VALUE', style: 'STYLE' },
  r20_i18n_select_option: { 'data-i18n': 'KEY', value: 'VALUE', style: 'STYLE' },
  ...
  r20_i18n_html: { 'data-i18n-html': 'KEY', style: 'STYLE' },
  ...
  r20_i18n_legend: { 'data-i18n': 'KEY', style: 'STYLE' },
  r20_raw_worker: {},
  ...
  r20_inline_break: { style: 'STYLE' },
  r20_table_caption: { class: 'CLASS', style: 'STYLE' },
  r20_label: { style: 'STYLE' },
  r20_fieldset: { class: 'CLASS', style: 'STYLE' },
  r20_repeating_section: { style: 'STYLE' },
  r20_row: { style: 'STYLE' },
  r20_col: { style: 'STYLE' },
  r20_colrow_n: { style: 'STYLE' },
  r20_section_wrap: { style: 'STYLE' },
  r20_toggle_wrap: { style: 'STYLE' },
  r20_repeating_row: { style: 'STYLE' },
  r20_grid: { style: 'STYLE' },
