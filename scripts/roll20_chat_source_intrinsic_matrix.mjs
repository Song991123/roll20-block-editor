...
function selfTest() {
  const report = buildReport('synthetic', {
    parity: { fixtures: [{ fixtureId: 'yshy-commission-1bu', bestAlignedMismatchRatio: 0.2 }] },
    sourceContext: {
      fixtures: [{
    ...
    intrinsicWidth: { fixtures: [{ fixtureId: 'yshy-commission-1bu', intrinsicDecision: 'TABLE_SCROLL_INTRINSIC_MODEL_REQUIRED' }] },
    tableIntrinsic: { fixtures: [{ fixtureId: 'yshy-commission-1bu', probeDecision: 'TABLE_WIDE_INTRINSIC_WITH_CROP_OFFSET', rowModel: { rowWidthDeltaSpread: 0, maxAbsCellDelta: 0.9, maxAbsTopDelta: 52.7 } }] },
    tableLayout: { fixtures: [{ fixtureId: 'yshy-commission-1bu', decision: 'TABLE_AUTO_LAYOUT_MIN_CONTENT_MODEL_REQUIRED', deltas: { tableWidth: -24.5, tableScrollWidth: -25 } }] },
    minContent: { fixtures: [{ fixtureId: 'yshy-commission-1bu', decision: 'TABLE_AUTO_LAYOUT_MIN_CONTENT_MODEL_REQUIRED', deltas: { tableWidth: -24.5, tableScrollWidth: -25, tableClientWidth: -25 }, constraints: { bothAutoLayout: true, actualExceedsComputedMax: true }, rowModel: { uniformRows: true, maxAbsCellDelta: 0.9, maxAbsTopDelta: 52.7 }, textMetrics: { tableTextDelta: -54.9, tableTextResidual: 30.4 } }] },
  });
