...
const modernLegacySurfaceCss = extractStyle(modernDoc, 'roll20-legacy-sheet-surface');
const legacySurfaceCss = extractStyle(legacyDoc, 'roll20-legacy-sheet-surface');
...
const modernShadowLegacySurfaceCss = extractStyleSourceChunk(modernParts.css, 'roll20-legacy-sheet-surface');
const legacyShadowSurfaceCss = extractStyleSourceChunk(legacyParts.css, 'roll20-legacy-sheet-surface');
